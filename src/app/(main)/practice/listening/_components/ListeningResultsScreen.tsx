...
export function ListeningResultsScreen({
  correctCount,
  wrongCount,
  totalCount,
  elapsedTime,
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      <p className={`font-semibold text-sm mb-1 ${result.correct ? "text-gray-900" : "text-red-900"}`}>
                        {result.term}
                      </p>
                      {!result.correct && (
                        <div className="text-xs space-y-0.5">
                          <p className="text-red-600/80">
                            <span className="opacity-75">Bạn nhập:</span> {result.userAnswer || "(bỏ trống)"}
                          </p>
                          <p className="text-gray-700 font-medium">
                            <span className="opacity-75">Đáp án:</span> {result.correctAnswer}
                          </p>
                        </div>
                      )}
                    </div>
