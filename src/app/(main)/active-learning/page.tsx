      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 lg:items-start">
        ...
        <section className="min-w-0 flex flex-col gap-8 lg:sticky lg:top-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-800">Phương pháp học</h2>
          </div>
              ...
              {WRITING_MODES.map((mode) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    onClick={() =>
                      !isDisabled && handleStartWritingMode(mode.id)
                    }
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Chọn luyện viết từ (một trong bốn kiểu), nghe và viết từ,
                    hoặc flashcard ôn nhanh, rồi bấm Bắt đầu.
                  </p>
                </div>
              </div>
            </div>
